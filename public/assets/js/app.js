!function () {
    ...
    function r(e) {
        document.querySelectorAll(".header-lang-img").forEach(function (t) {
            if (t) {
                ...
                localStorage.setItem("language", e), o = localStorage.getItem("language"), function () {
                    null == o && r(l);
    ...
    }), document.addEventListener("fullscreenchange", y), document.addEventListener("webkitfullscreenchange", y), document.addEventListener("mozfullscreenchange", y), function () {
